...
exports.getDashboardMatrix = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
const getDashboardMatrix = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCatgorySummaryRaw = yield prisma.expenseByCategory.findMany({
            take: 5,
            orderBy: {
                date: "desc",
            },
...
exports.getDashboardMatrix = getDashboardMatrix;
